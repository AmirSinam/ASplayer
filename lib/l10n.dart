...
class Strings {
  const Strings({
    ...
    required this.noLyrics,
    required this.editLyrics,
    required this.lyricsHint,
    required this.editSong,
    required this.changeCover,
    required this.save,
    required this.fieldTitle,
    required this.fieldArtist,
    required this.fieldAlbum,
    required this.moments,
    required this.saveMoment,
    required this.momentSaved,
    required this.noMoments,
  ...
  final String lyrics, noLyrics, editLyrics, lyricsHint;
  final String editSong, changeCover, save, fieldTitle, fieldArtist, fieldAlbum;
  final String moments, saveMoment, momentSaved, noMoments;
  ...
  static const en = Strings(
    ...
    lyricsHint: 'Paste the lyrics. For synced highlighting, use LRC lines like [00:12.50] text.',
    editSong: 'Edit',
    ...
    noMoments: 'No saved moments yet',
  ...
  static const fa = Strings(
    ...
    appearanceDark: 'تیره',
    lyrics: 'متن ترانه',
    noLyrics: 'هنوز متنی نیست',
    editLyrics: 'ویرایش متن',
    lyricsHint: 'متن را بچسبان. برای هماهنگی خط‌به‌خط، از فرمت LRC مثل [00:12.50] متن استفاده کن.',
    editSong: 'ویرایش',
    ...
    fieldAlbum: 'آلبوم',
    moments: 'لحظه‌ها',
    saveMoment: 'ذخیره‌ی این لحظه',
    momentSaved: 'لحظه ذخیره شد',
    noMoments: 'هنوز لحظه‌ای ذخیره نشده',
